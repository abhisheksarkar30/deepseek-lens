...
| `internal/analyze` | Rule engine that detects DeepSeek's silent parameter drops/rewrites and emits `store.Warning`s | [internal/analyze/rules.go](../../internal/analyze/rules.go), [internal/analyze/kinds.go](../../internal/analyze/kinds.go) |
